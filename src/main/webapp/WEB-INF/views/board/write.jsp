...
<div class="container">
	<div class="row">
  		<div class="col-lg-12">
    		<div class="card">
      			<div class="card-header text-white" style="background-color: #00008B;"> 게시글 등록</div>
      				<div class="card-body">
        				<form role="form" method="post">
							...
							style="cursor: pointer; margin-top: 0; height: 40px; color: white; background-color: #00008B; border: 0px solid #388E3C; opacity: 0.8">취소</a>
        				</form>
      				</div>
    			</div>
  			</div>
